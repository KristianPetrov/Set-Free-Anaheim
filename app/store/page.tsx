    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="container mx-auto px-4 pt-28 md:pt-32">
        <div className="relative w-64 h-64 sm:w-72 sm:h-72 md:w-96 md:h-96 mx-auto mb-4 animate-slow-glow">
          ...
          <div className="pointer-events-none absolute -top-3 -right-3 sm:-top-4 sm:-right-4 md:-top-6 md:-right-6 w-16 h-16 sm:w-20 sm:h-20 md:w-28 md:h-28 rotate-12 z-10">
            <Image
